...
export class AppComponent {
  ...
  //   console.log('toggle content' , this.flag);
  // }
  
}

// var testObj = new AppComponent()
// setTimeout(function(){
//   testObj.value = 'Ravi';
// },10000)
